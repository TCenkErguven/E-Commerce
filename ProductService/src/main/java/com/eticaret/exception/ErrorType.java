...
public enum ErrorType {
    ...
    USER_DELETED(4500, "Bu kullanıcı silinmiştir.", HttpStatus.BAD_REQUEST),
    ACTIVATE_CODE_ERROR(4600, "Aktivasyon kod hatası", HttpStatus.BAD_REQUEST),
    USER_NOT_ACTIVE(4700, "User aktif değildir.", HttpStatus.BAD_REQUEST),
    INVALID_TOKEN(4800,"Token hatası" ,  HttpStatus.BAD_REQUEST),
    TOKEN_NOT_CREATED(5000, "Token oluşturulamadı", HttpStatus.BAD_REQUEST);
